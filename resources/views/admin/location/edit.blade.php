                                ...
                                <form action="{{ route('admin.location.update', $location->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="id_location"
                                            class="form-control @error('id_location') is-invalid @enderror"
                                            value="{{ old('id_location', $location->id_location) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            value="{{ old('name', $location->name) }}" placeholder="Nama" />
                                        @error('name')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
